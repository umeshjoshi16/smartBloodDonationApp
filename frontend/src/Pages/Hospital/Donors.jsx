...
const donors = [
  {
    ...
    bloodType: "AB-",
    phone: "9843658116",
    email: "nikita.thapa@gmail.com",
    totalDonations: 17,
    lastDonated: "3/31/2025",
    daysSince: 410,
    eligible: true,
  },
  {
  ...
  },
  {
    ...
    bloodType: "O-",
    phone: "1234567890",
    email: "mukesh@gmai.com",
    totalDonations: 1,
    lastDonated: "3/8/2026",
    daysSince: 68,
    eligible: false,
  },
  {
    ...
    bloodType: "A+",
    phone: "9863950225",
    email: "puja.joshi769@outlook.com",
    totalDonations: 1,
    lastDonated: "3/26/2025",
    daysSince: 415,
    eligible: true,
  },
];
        ...
        <div className="bg-white rounded-xl border border-gray-100 overflow-hidden shadow-sm">
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1.5 text-sm text-gray-700">
                          ...
                          <span className="whitespace-nowrap">{donor.phone}</span>
                        </div>
                      </td>
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1.5 text-sm text-gray-500 max-w-50">
                          ...
                          <span className="">{donor.email}</span>
                        </div>
                      </td>
          ...
          <div className="px-4 py-3 border-t border-gray-100 flex items-center justify-between ">
            ...
            <p className="text-xs text-gray-600 text-center">
              Civil Hospital- Blood Donor Management
            </p>
          </div>
